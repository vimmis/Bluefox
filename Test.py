...
ping = 'http://localhost:3000/pingLB'
add = "http://localhost:3000/add_temperature_measurement"
get_measurement = "http://localhost:3000/get_temperature_measurements"
get_avg = "http://localhost:3000/get_average_temperature"
...
response = requests.request("POST", add, data=payload, headers=headers)
...
responseq = requests.request("POST", add, data=payload, headers=headers)
print("Response: \n")
...
responsea = requests.request("POST", add, data=payload, headers=headers)
print("Response: \n")
...
responses = requests.request("POST", add, data=payloadd, headers=headers)
print("Response: \n")
...
responsez = requests.request("GET", get_measurement, headers=headers, params=querystring)
...
responsew = requests.request("GET", get_measurement, headers=headers, params=querystring)
print("Response: \n")
...
responsex = requests.request("GET", get_measurement, headers=headers, params=querystring)
print("Response: \n")
...
response = requests.request("GET", get_measurement, headers=headers, params=querystring)
print("Response: \n")
print(response.text)
...
response = requests.request("GET", get_avg, headers=headers, params=querystring)
print("Response: \n")
print(response.text)
